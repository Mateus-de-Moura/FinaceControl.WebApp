...
export const GetUsers = async (search: string, page: number, pageSize: number) => {
  const response = await Api.get(`/api/User?PageNumber=${page}&PageSize=${pageSize}&Description=${encodeURIComponent(search)}`);
